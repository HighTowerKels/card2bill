...
const AwaitVerificationScreen = ({ navigation }) => {
  const classes = [
    {
      startTime: '09:00',
      endTime: '10:30',
      title: 'Accepted Gift Card',
      bgColor:'#E0FFFF',
      students: [
  ...
  return (
    <View style={styles.container}>
     ...
     <TouchableOpacity
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.h3 }}>Go back to dashboard</Text>
                </TouchableOpacity>
     </View>
    </View>
  );
...
export default AwaitVerificationScreen;