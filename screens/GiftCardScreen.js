  ...
  return (
    <ScrollView style={styles.container}>
      <Appbar.Header>
        ...
        <Appbar.Content title="Gift Cards" />
      </Appbar.Header>
      
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('GiftCardModalScreen')}
        >
          <ImageBackground
          ...
          >
            <Text style={styles.buttonText}>Sell Gift Card</Text>
          </ImageBackground>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('BuyGift')}
        >
          <ImageBackground
